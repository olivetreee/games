...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  var $gridEl = (0, _jquery2.default)("#game");
	  var grid = new _grid2.default($gridEl);
	  var game = new _game2.default(grid);
	  window.game = game;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //On each move, add class to the tile with:
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function flashRoundPoints() {
	      var bubble = document.getElementsByClassName("points-bubble")[0];
	      (0, _jquery2.default)(bubble).text(this.grid.roundPoints);
	      bubble.animate({
	        opacity: [0, 1, 0],
	    ...
	    value: function updateScore() {
	      ...
	      (0, _jquery2.default)(".game-score span").text(this.gamePoints);
	    }
	  }, {
	    key: "gameOver",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tile2 = __webpack_require__(4);
	...
	var Grid = function () {
	  ...
	  _createClass(Grid, [{
	    ...
	    value: function setupGrid() {
	      var $gridContainer = (0, _jquery2.default)("<div class='grid-container'>");
	
	      var $gridRow = void 0;
	
	      for (var row = 1; row < 5; row++) {
	        $gridRow = (0, _jquery2.default)("<div class='grid-row clearfix'>");
	        for (var cell = 1; cell < 5; cell++) {
	          var $gridCell = (0, _jquery2.default)("<div class='grid-cell'>");
	      ...
	      var $tileContainer = (0, _jquery2.default)("<div class='tile-container'>");
	      (0, _jquery2.default)(".grid-container").append($tileContainer);
	    }
	  }, {
	    key: "spawnTile",
	    value: function spawnTile() {
	      var pos = this.randomPosition();
	      var newTile = new _tile3.default(pos);
	      ...
	      // window.setTimeout(() => {
	      (0, _jquery2.default)(".tile-container").append(newTile.$html);
	      // }, 200);
	    ...
	    key: "positionTaken",
	    value: function positionTaken(r, c) {
	      return this.filledPositions[this.posToString(r, c)];
	    }
	  }, {
	    key: "posToString",
	    value: function posToString(r, c) {
	      return "" + r + c;
	    }
	  }, {
	    key: "removeMerged",
	    ...
	    key: "searchTilesToMerge",
	    value: function searchTilesToMerge(key) {
	      var _defineLoopParams = this.defineLoopParams(key),
	          increment = _defineLoopParams.increment,
	          startAt = _defineLoopParams.startAt,
	          direction = _defineLoopParams.direction;
	      ...
	      for (var cell = 0; cell < 16; cell++) {
	        ...
	        var cellContent = this.filledPositions[pos];
	        if (cellContent) {
	    ...
	    key: "findNextTile",
	    value: function findNextTile(pos, increment, direction) {
	      var _pos$split$map = pos.split("").map(function (coord) {
	        return parseInt(coord);
	      }),
	          _pos$split$map2 = _slicedToArray(_pos$split$map, 2),
	          row = _pos$split$map2[0],
	          col = _pos$split$map2[1];
	
	      if (direction === "V") {
	        var nextRow = row + increment;
	        while (nextRow > 0 && nextRow < 5) {
	          var nextPos = this.posToString(nextRow, col);
	          var tile = this.filledPositions[nextPos];
	          if (this.filledPositions[nextPos]) return tile;
	          nextRow += increment;
	        }
	      } else {
	        var nextCol = col + increment;
	        while (nextCol > 0 && nextCol < 5) {
	          var _nextPos = this.posToString(row, nextCol);
	          var _tile = this.filledPositions[_nextPos];
	          if (this.filledPositions[_nextPos]) return _tile;
	          nextCol += increment;
	        }
	      }
	      return false;
	    ...
	    key: "mergeTiles",
	    value: function mergeTiles(tileA, tileB) {
	    ...
	    key: "moveTiles",
	    value: function moveTiles(key) {
	      //direction can be "UP", "DOWN", "LEFT", "RIGHT"
	      var _defineLoopParams2 = this.defineLoopParams(key),
	          increment = _defineLoopParams2.increment,
	          startAt = _defineLoopParams2.startAt,
	          direction = _defineLoopParams2.direction;
	    ...
	    key: "defineLoopParams",
	    value: function defineLoopParams(key) {
	      var params = {};
	      switch (key) {
	        case "UP":
	          params.increment = 1;
	    ...
	    key: "searchAndMove",
	    value: function searchAndMove(row, col, increment, direction) {
	      var emptyPos = this.posToString(row, col);
	      // debugger
	
	      if (direction === "V") {
	        var oldRow = row + increment;
	        while (oldRow > 0 && oldRow < 5) {
	          var oldPos = this.posToString(oldRow, col);
	        ...
	        var oldCol = col + increment;
	        while (oldCol > 0 && oldCol < 5) {
	          var _oldPos = this.posToString(row, oldCol);
	          if (this.filledPositions[_oldPos]) {
	            this.filledPositions[emptyPos] = this.filledPositions[_oldPos];
	            // this.filledPositions[emptyPos].setPosition(emptyPos);
	            this.filledPositions[_oldPos] = false;
	
	            this.mergedTiles[emptyPos] = this.mergedTiles[_oldPos];
	            this.mergedTiles[_oldPos] = false;
	    ...
	    key: "isGridFull",
	    value: function isGridFull() {
	      return this.tileCount === 16;
	    }
	  }, {
	    key: "isBeatingScore",
	    value: function isBeatingScore(score) {
	      return (0, _lodash.findKey)(this.filledPositions, ['value', score]);
	    }
	  }, {
	    key: "renderDom",
	    value: function renderDom() {
	      ...
	      (0, _lodash.keys)(this.filledPositions).forEach(function (pos) {
	        var tile = _this.filledPositions[pos];
	        if (tile) tile.setPosition(pos);
	      });
	
	      (0, _lodash.keys)(this.mergedTiles).forEach(function (pos) {
	        var tile = _this.mergedTiles[pos];
	        if (tile) tile.setPosition(pos);
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Tile(position) {
	  var merged = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	
	  this.value = Math.round(Math.random() + 1) * 2;
	  this.position = position;
	
	  this.$html = "";
	  this.$outerHtml = (0, _jquery2.default)("<div class='tile-wrapper pos-" + position + "'></div>");
	  this.$innerHtml = (0, _jquery2.default)("<div class='tile val-" + this.value + "'>" + this.value + "</div>");
	  this.mountHtml();
	...
	Tile.prototype.removeSelf = function () {
	  var htmlClass = ".pos-" + this.position;
	  debugger;
	  window.setTimeout(function () {
	    return (0, _jquery2.default)(htmlClass).remove();
	  }, 200);
	};
	...
	Tile.prototype.spawn = function () {
	  // debugger
	  var tileClass = ".pos-" + this.position;
	  var tileEl = document.querySelector(tileClass + " .tile");
